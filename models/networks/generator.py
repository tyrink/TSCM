...
class SPADEGenerator(BaseNetwork):
    ...
    def __init__(self):
        ...
        self.fc = nn.Conv2d(19, 16 * nf, 3, padding=1)

        self.head_0 = SPADEResnetBlock(16 * nf, 16 * nf, Block_Name='head_0')

        self.G_middle_0 = SPADEResnetBlock(16 * nf, 16 * nf, Block_Name='G_middle_0')
        self.G_middle_1 = SPADEResnetBlock(16 * nf, 16 * nf, Block_Name='G_middle_1')

        self.up_0 = SPADEResnetBlock(16 * nf, 8 * nf, Block_Name='up_0')
        self.up_1 = SPADEResnetBlock(8 * nf, 4 * nf, Block_Name='up_1')
        self.up_2 = SPADEResnetBlock(4 * nf, 2 * nf, Block_Name='up_2')
        self.up_3 = SPADEResnetBlock(2 * nf, 1 * nf, Block_Name='up_3', use_rgb=False)
