...
class EyeDis(nn.Module):
    def __init__(self, nfeatures, bn=False, increase=0, **kwargs):
        super(EyeDis, self).__init__()
        ...
        self.gaze_fc = nn.Linear(in_features=256, out_features=2)
