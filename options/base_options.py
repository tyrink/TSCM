...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='try', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--dist', type=str, default=False, help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--seed', type=int, default=1234, help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--model', type=str, default='unet', help='which model to use')
        self.parser.add_argument('--logdir', type=str, default='/home1/lfy/try/code_sims/SimSwap-main/log', help='which path to save log')
        ...
        self.parser.add_argument('--single_gpu', type=str, default=True)
        ...
        self.parser.add_argument('--dataset_name', type=str, default='dd', help='local rank for distributed training')
        self.parser.add_argument('--use_mlp', type=bool, default=False, help='local rank for distributed training')
        ...
        # for setting inputs
        # self.parser.add_argument('--dataroot', type=str, default='/data2/lfy/SimSwap-train-main/dataset/FFHQ')
